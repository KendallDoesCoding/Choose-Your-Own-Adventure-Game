...
class GUI:
    ...
    def set_params(self, screen_width: int, screen_height: int, screen: pygame.Surface):
        ...
        self.button_left = Button(screen_width * .25, screen_height * .9, 200, 60, text="LEFT",
                                  font=self.button_font, bg_color=(200, 200, 200), hover_color=(220, 220, 220))
        self.button_right = Button(screen_width * .75, screen_height * .9, 200, 60, text="RIGHT",
                                   font=self.button_font, bg_color=(200, 200, 200), hover_color=(220, 220, 220))
        ...
        self.background = pygame.transform.smoothscale(pygame.image.load(
            "assets/images/landscape.png"), (bg_height * 1.778, bg_height))
    ...
    def text_until_enter(self, text: str):
        ...
        enter_text = self.small_font.render(
            "Press Enter to continue", True, (0, 0, 0))
    ...
    def exit_func(self):
        # stop music thread, make sure to call these 2 lines every time program exits
        musicTimer.musicTimerObj.cancel()
    ...
    def start_screen(self):
        ...
        music_toggle = Toggle(self.screen_width - self.music_toggle_size - 20, 20, "assets/images/MusicOn.png",
                              "assets/images/MusicOff.png", (self.music_toggle_size, self.music_toggle_size))
