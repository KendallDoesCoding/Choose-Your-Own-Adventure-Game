...
class GUI:
    ...
    def set_params(self, screen_width: int, screen_height: int, screen: pygame.Surface):
        ...
        self.background = pygame.transform.smoothscale(
            pygame.image.load("assets/images/landscape.png"),
            (bg_height * 1.778, bg_height),
        )
    ...
    def text_until_enter(self, text: str):
        ...
        while True:
            ...
            self.screen.blit(
                enter_text,
                (
                    self.screen_width / 2 - enter_text.get_size()[0] / 2,
                    self.screen_height * 0.9 - enter_text.get_size()[1] / 2,
                ),
            )
            pygame.display.update()
    ...
    def start_screen(self):
        ...
        name_text_box = TextBox(
            (
                self.screen_width / 2 - text_box_w / 2,
                self.screen_height * 0.7 - text_box_h / 2,
                text_box_w,
                text_box_h,
            ),
            font=self.font,
        ...
        music_toggle = Toggle(
            self.screen_width - self.music_toggle_size - 20,
            20,
            "assets/images/MusicOn.png",
            "assets/images/MusicOff.png",
            (self.music_toggle_size, self.music_toggle_size),
        )
        ...
        while not got_name:
            ...
            self.screen.blit(
                self.logo,
                (
                    self.screen_width / 2 - self.logo.get_size()[0] / 2,
                    self.screen_height * 0.3 - self.logo.get_size()[1] / 2,
                ),
            )
            ...
            self.screen.blit(
                text,
                (
                    self.screen_width / 2 - text.get_size()[0] / 2,
                    self.screen_height * 0.85,
                ),
            )
    ...
    def __ask_question_no_gui(
        self,
        question: str,
        first: str,
        second: str,
        color_before: Fore = None,
        color_after: Fore = None,
    ) -> bool:
        while True:
            q = ""
