...
def start():
    answer = input(Fore.GREEN + "You are on a dirt road. Which way to you want to go left or right? " +
...
def chapter_river():
    ...
    if answer == "swim":
        game_over(
            Fore.RED + "You swam across the river and were eaten by an aligator \U0001F480")
    # if user inputs walk then
        ...
        if answer == "no":
            game_over(
                Fore.RED + "You were very de-hydrated and died of thirst when you were walking. \U0001F480")
...
def chapter_stranger():
    ...
    if answer == "n":
        game_over(
            Fore.RED + "The stranger was not pleased by you and murdered you. \U0001F480")
    elif answer == "y":
        answer = input(Fore.GREEN +
