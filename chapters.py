...
def chapter_river():
    ...
    if answer == "swim":
        game_over("You swam across the river and were eaten by an aligator.")
    # if user inputs walk then
        ...
        if answer == "no":
            game_over("You were very de-hydrated and died of thirst when you were walking.")
...
def chapter_stranger():
    ...
    if answer == "y":
        ...
        if answer == "y":
            ...
            game_over("The wizard was not pleased by you and"
                      "gave you posion. You died.")

    elif answer == "n":
        answer = input("The stranger murdered you.")
        game_over()
