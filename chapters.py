...
def chapter_river():
    answer = input(
        Fore.GREEN + "You come to a river, you can walk around it or swim across."
        "Type walk to walk around & swim to swim across. " + Fore.LIGHTMAGENTA_EX
    ).lower()
    ...
    # if user inputs walk then
        ...
        # q2
        answer = input(
            Fore.GREEN + "You walked for many miles, ran out of water and remembered "
            "that there was a shop far away (10 miles/16kms) which supplies water."
            "Do you want to go there (yes/no)? " + Fore.LIGHTMAGENTA_EX
        ).lower()
...
def chapter_bridge():
    ...
    if answer == "forward":
        game_over(
            Fore.RED + "You drive forward and crash into a tree and die.\U0001F480 "
        )
...
def chapter_lake():
    answer = input(
        Fore.GREEN + "You turned left and you come to a lake,"
        "do you want to swim or go back? (swim/back) " + Fore.LIGHTMAGENTA_EX
    ).lower()
    if answer == "swim":
        game_over(
            Fore.RED + "You swam across the lake and were eaten by a shark. \U0001F480 "
        )
...
def chapter_stranger():
    ...
    if answer == "n":
        ...
        answer = input(
            Fore.GREEN + "You talk a wizard and they ask you,"
            "do you want to be a wizard? (y/n) " + Fore.LIGHTMAGENTA_EX
        ).lower()
        if answer == "y":
            game_over(
                Fore.RED + "You are a wizard and you WIN the game! \U0001f3c6", win=True
            )
        elif answer == "n":
            game_over(
                Fore.RED
...
def game_over(message: str = None, *, end_game=True, win=False):
    ...
    answer = input(
        Fore.GREEN + "Do you want to play again? (y/n) " + Fore.LIGHTMAGENTA_EX
    ).lower()
    if answer == "y":
        start()
    elif answer == "n":
